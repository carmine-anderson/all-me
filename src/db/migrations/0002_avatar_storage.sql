...
-- Creates a public "avatars" bucket in Supabase Storage and sets up RLS policies
-- so each user can only upload/update/delete their own avatar, but anyone can read.
...
-- 5. Allow public read access (bucket is public, but explicit policy for clarity)
